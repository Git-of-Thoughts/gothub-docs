...
- [x] Enable admin-level users to CRUD agents, abilities, and oracles.
- [x] Display all logging information to users (developers).
...
- [ ] Try to create a agent that performs really well (as much as possible) on the APPS benchmark.
  - [ ] Perhaps types (Dynamic Programming, Greedy, ...) tutorials
  - [ ] Perhaps types (Dynamic Programming, Greedy, ...) templates, and next step fill in blanks
  - [ ] Python execution tool, if fails, try again
